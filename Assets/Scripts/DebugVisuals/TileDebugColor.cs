...
namespace Burmalda.DebugVisuals
{
    ...
    public static class TileDebugColor
    {
        ...
        /// роль (уже приглушённый, в общей тёплой палитре), тон больше не
        /// применяется (<c>ApplyVisual</c> показывает текстуру как есть).
        /// Константа оставлена — вернуть тон тривиально, если плейтест на
        /// устройстве покажет, что новая текстура всё равно заметнее источников.
        /// </summary>
