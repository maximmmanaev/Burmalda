...
namespace Burmalda.DebugVisuals
{
    ...
    public static class TileDebugColor
    {
        ...
        // Владелец, 2026-09-05 («оставить только пять новых ловушек»): Яма
        // (PitColor) и мгновенный Взрыв (ExplosionColor/ExplosiveTriggerColor)
        // убраны из игры целиком вместе со своими константами — старые
        // цвета этой семьи (PitColor/ExplosionColor/ExplosiveTriggerColor/
        // TimedTrapTriggerColor/HiddenTrapSignatureColor/
        // HiddenTrapSignatureTextureTint) больше не описывают ни одно
        // существующее состояние, удалены, а не оставлены "для истории" —
        // история и так в git.
        //
        // Единая сигнатура механизма (см. TriggerSignatureColor ниже) —
        // факт "здесь механизм" виден всем (плита-триггер сама по себе
        // безопасна), какой именно — уровень Идола Чутья
        // (TrapInsight.HasTrapTypeInsight).
        ...
        /// однозначно "на это можно нажать".
        /// </summary>
        ...
        /// триггер) проверяются РАНЬШЕ ролевых и декоративных
        ...
        public static Color Resolve(TileVisualState state)
        {
            ...
            // ниже, до градиента распада в самом конце.
