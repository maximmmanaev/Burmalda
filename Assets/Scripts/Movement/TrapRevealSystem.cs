...
namespace Burmalda.Movement
{
    ...
    /// — или триггер механизма, взрывной/с таймингом) ничем не отличается
    /// от обычного пола, пока игрок хотя бы раз не навёл на плиту палец
    /// (<see cref="GridTraceInputController.PreviewTarget"/>). Раскрытие —
    ...
    public sealed class TrapRevealSystem
    {
        ...
        // Ровно те же два состояния, что делят одну сигнатуру в
