...
namespace Burmalda.Movement
{
    ...
    /// и вызывает <see cref="Tick"/> явно — единица хода, а не секунды. Если
    /// бы планировщик подписывался на трейл сам, а
    ...
    /// экземпляр на забег — этот класс не знает и не должен знать, ЧТО означает
