...
namespace Burmalda.Movement
{
    ...
    public sealed class TunnelCameraFollow : IDisposable
    {
        ...
        /// <see cref="TunnelCameraController"/> напрямую (issue #153,
        /// тумблер 2) — анкор-производная TrailingDistance подмешивается
        /// плавно, синхронно с твином интро, а не резким переключением в
        /// момент ConfirmRun (иначе во время top-down интро, на сильно
        /// другом Pitch, анкор-геометрия для устоявшегося режима уводит
        /// камеру мимо стартовой плиты). См. <see cref="ComputeIntroTweenProgress01"/>.
        /// </summary>
