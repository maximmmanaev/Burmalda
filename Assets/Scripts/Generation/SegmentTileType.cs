namespace Burmalda.Generation
{
    ...
    public enum SegmentTileType
    {
        ...
        /// <c>Movement.RealTimeThreatScheduler</c>) были написаны и покрыты
        ...
        /// закрывают (владелец, 2026-09-05, «оставить только пять новых
        /// ловушек»: прежние Pit/ExplosiveTrigger/TimedTrapArrowTrigger/
        /// TimedTrapBladeTrigger, для которых эти пять изначально были
        /// аналогией, удалены целиком — эти пять теперь единственные типы
        /// ловушек в игре).
        ///
