...
| `Trials/` | `DailyTrial` (минимальная версия — общий seed + награды по порогу, без лидерборда, §23.1) в Спринте 9; `WeeklyTrial`/`TrialStreak` (§23.2–23.3) — пост-релизным апдейтом, вместе с остальным live-ops | [Спринт 9](https://github.com/maximmmanaev/Burmalda/milestone/9) → [Апдейт: Live-ops](https://github.com/maximmmanaev/Burmalda/milestone/13) |
